<div>
    <form wire:submit="submitted">
        ...
        <div class="row g-3 align-items-center mb-3">
            <div class="col-auto">
              <input type="file" id="userCsv" class="form-control" aria-describedby="uploadFstCsvHelp" wire:model="uploading_file" accept=".csv" >
            </div>
            <div class="col-auto">
                <span id="uploadFstCsvHelp" class="form-text">
                    This file is expected to consist of 26 columns.
                </span>
            </div>
        </div>
